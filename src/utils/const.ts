export const API_KEY:string = 'k_vx2f1tac';
export const EMAIL_REGEXP =
  /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
export const PASSWORD_REGEXP = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/;
export const LOGIN_REGEXP = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{4,}$/;
export const VALIDATE_CONFIG = {
  requiredMessage: 'Поле обязательно к заполнению',
  loginMessage: 'Логин должен содержать минимум четыре символа латинского алфавита',
